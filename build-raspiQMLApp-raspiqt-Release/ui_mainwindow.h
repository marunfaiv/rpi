...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        txtLabel->setContextMenuPolicy(Qt::DefaultContextMenu);
        txtLabel->setLayoutDirection(Qt::LeftToRight);

        gridLayout->addWidget(txtLabel, 0, 0, 1, 1);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        txtLabel->setText(QCoreApplication::translate("MainWindow", "AAA", nullptr));
